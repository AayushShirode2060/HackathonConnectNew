...
<section class="bg-slate-900">
    <div class="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
        <nav class="flex flex-wrap justify-center -mx-5 -my-2">
            <div class="px-5 py-2">
                <Link href={"/hackathons"} class="text-base leading-6 text-gray-500 hover:text-white">
                Hacakthon
                </Link>
            </div>
            <div class="px-5 py-2">
                <Link href={"/viewTeam"} class="text-base leading-6 text-gray-500 hover:text-white">
                 View Team
                </Link>
            </div>
            <div class="px-5 py-2">
                <Link href={"/profile"} class="text-base leading-6 text-gray-500 hover:text-white">
                   Profile
                </Link>
            </div>
            <div class="px-5 py-2">
                <Link href="#" class="text-base leading-6 text-gray-500 hover:text-white">
                    Sign-out
                </Link>
            </div>
            <div class="px-5 py-2">
                <a href="/contact_us" class="text-base leading-6 text-gray-500 hover:text-white">
                    Contact
                </a>
            </div>
            <div class="px-5 py-2">
